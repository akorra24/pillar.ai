  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="flex flex-row h-[80%] w-[95%] 2xl:w-[60%] relative">
        <div className=" flex-col items-start justify-between p-4 text-white bg-black hidden md:flex md:opacity-100 bg-opacity-75 rounded-3xl w-full">
        ...
        <div className="flex flex-col justify-center text-white bg-black bg-opacity-80 rounded-3xl absolute right-0 h-full w-[100%] md:w-[50%]">
          <h3 className="ml-10 mb-5 xs:mb-10 text-2xl font-bold">Login</h3>
          <div className="flex flex-row justify-evenly items-center w-full flex-wrap">
            <button
              className="border-2 border-white text-center rounded-lg px-2 py-3 m-1 flex flex-row items-center min-w-48"
          ...
          <div className="flex flex-col items-center justify-center my-2 xs:my-10">
            <p>-OR-</p>
          </div>
